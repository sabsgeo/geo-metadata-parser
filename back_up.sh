...
mongoexport --uri "mongodb://user:user@127.0.0.1:27017/geodatasets" --authenticationDatabase admin --collection pmc_metadata --out "/home/ubuntu/pmc_metadata${D}.json"